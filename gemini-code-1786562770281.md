...
<table>
  <tr>
    ...
    <td width="40%" align="center">
      <img src="imagenes/botones_reed_switches.jpg" alt="Botones y sensores" width="40%"><br>
...
<table>
  <tr>
    ...
    <td width="40%" align="center">
      <img src="imagenes/leds_buzzer.jpg" alt="LEDs y buzzer" width="40%"><br>
...
| :--- | :--- | :--- | :---: |
| **Hardware** | Verificación de continuidad | Ausencia de cortocircuitos o falsos contactos en la placa experimental | [COMPLETAR] |
| **Hardware** | Respuesta correcta de botoneras y reed switches | Mapeo correcto de botoneras (interior/exterior) y sensores de piso/puerta a sus eventos | [COMPLETAR] |
| **Hardware** | Correcta visualización del LCD | Actualización en tiempo real del piso actual y mensajes de estado | [COMPLETAR] |
| **Hardware** | Correcto funcionamiento de la celda de carga | Lectura estable por I2C y detección de sobrecarga ante un peso conocido | [COMPLETAR] |
| **Firmware** | FSM de antirrebote de pulsadores y reed switches | Filtrado exitoso de rebotes mecánicos sin pérdida de eventos | [COMPLETAR] |
| **Firmware** | Correcta interpretación de la celda de carga | Mapeo estable de las lecturas del NAU7802 a la detección de sobrecarga por software | [COMPLETAR] |
| **Firmware** | Persistencia en EEPROM externa | Lectura y escritura correcta de parámetros de configuración por bus I²C | [COMPLETAR] |
| **Firmware** | Máquina de estados global | Transiciones robustas entre IDLE, viaje y puerta, con prioridad absoluta de la emergencia | [COMPLETAR] |
